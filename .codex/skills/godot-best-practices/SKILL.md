...
### Architecture
- `references/2-1-3-6-7-2-??/project-structure.md` - Directory organization
- `references/2-1-3-6-7-2-??/scene-composition.md` - Scene design patterns
- `references/2-1-3-6-7-2-??/node-communication.md` - Signals vs direct calls
